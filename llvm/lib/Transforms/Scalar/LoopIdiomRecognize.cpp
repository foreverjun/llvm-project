...
private:
  ...
  void transformLoopToCtz(BasicBlock* PreCondBB, Instruction* CntInst, PHINode* CntPhi, Value* Var);
...
bool LoopIdiomRecognize::runOnNoncountableLoop() {
  ...
  return recognizePopcount() || recognizeAndInsertFFS() ||
         recognizeShiftUntilBitTest() || recognizeShiftUntilZero() || recognizeAndInsertCtz ();
}
...
void LoopIdiomRecognize::transformLoopToCtz(
